...
class TypeCode(enum.StrEnum):
    ...
    Code list: [UNTDID 1001](https://service.unece.org/trade/untdid/d16b/tred/tred1001.htm).
    """
...
class CategoryCode(enum.StrEnum):
    ...
    Code list: [UNTDID 5305](https://service.unece.org/trade/untdid/d16b/tred/tred5305.htm).
    """
...
class Currency(enum.StrEnum):
    ...
    Code list: [ISO 4217](https://www.iso.org/iso-4217-currency-codes.html).
...
class Country(enum.StrEnum):
    ...
    Code list: [ISO 3166-1 alpha-2](https://www.iso.org/iso-3166-country-codes.html).
...
class UNTDID4461PaymentMeansCode(enum.StrEnum):
    ...
    Code list: [UNTDID 4461](https://service.unece.org/trade/untdid/d16b/tred/tred4461.htm).
...
class UNTDID5189AllowanceReasonCode(enum.StrEnum):
    ...
    Code list: [UNTDID 5189](https://service.unece.org/trade/untdid/d16b/tred/tred5189.htm).
...
class UNTDID2475TaxPointDateCode(enum.StrEnum):
    ...
    Code list: [UNTDID 2475](https://service.unece.org/trade/untdid/d16b/tred/tred2475.htm).
...
class EASCode(enum.StrEnum):
    ...
    Code list: [EAS](https://docs.peppol.eu/poacc/billing/3.0/codelist/eas/).
...
class VATEXCode(enum.StrEnum):
    ...
    Code list: [VATEX](https://docs.peppol.eu/poacc/billing/3.0/codelist/vatex/).
